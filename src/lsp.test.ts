...
describe("LSP protocol tests", () => {
  ...
  describe("With Initialized Server", () => {
    ...
    test("Update document", async () => {
      ...
      server_connection.onNotification(protocol.DidChangeTextDocumentNotification.type, async (params) => {
        expect(params).toEqual(
          {
            "contentChanges": [
              { "text": NEW_CONTENT, "range": { "start": { "line": 0, "character": 0 }, "end": { "line": 0, "character": 11 } }, }
            ],
            "textDocument": {
              "uri": URI,
              "version": 2
      ...
      server_connection.onNotification(protocol.DidSaveTextDocumentNotification.type, async (params) => {
        expect(params).toEqual(
          {
            "textDocument": {
              "uri": URI,
      ...
      server_connection.onNotification(protocol.DidOpenTextDocumentNotification.type, async (params) => {
