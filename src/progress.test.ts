...
describe("Progress Reporting conversion", () => {
  ...
  test.each([
    // WorkDoneProgressBegin tests
    {
      ...
      input: { kind: "begin", title: "Test Title", message: "Test Message", percentage: 25 } as WorkDoneProgressBegin,
      expected: {
    ...
    },
    {
      ...
      input: { kind: "begin", title: "Fallback Title", percentage: 50 } as WorkDoneProgressBegin,
      expected: {
        method: "notifications/progress",
        params: {
          progress: 50,
    ...
    // WorkDoneProgressReport tests
    {
      ...
      input: { kind: "report", message: "Progress Update", percentage: 75 } as WorkDoneProgressReport,
      expected: {
        method: "notifications/progress",
        params: {
          progress: 75,
